...
-- ----------------------------
-- Table structure for lp_ml_saccvt_deduction_cla_tp_fgs
-- ----------------------------
DROP TABLE IF EXISTS `lp_ml_saccvt_deduction_cla_tp_fgs`;
CREATE TABLE `lp_ml_saccvt_deduction_cla_tp_fgs`  (
  ...
  `DEDUCTION_TYPE` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '抵扣类型',
  ...
  `SETTLEMENT_PGCODE` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '结算包',
  `CLAIM_CODE` varchar(1024) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '赔案号',
  `TARGET_CAR` varchar(1024) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '标的车牌号',
  `THIRD_CAR` varchar(1024) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '三者车牌号',
  `ADJUSTMENT_CODE` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '理算书',
  `TAX_AMOUNT` decimal(32, 10) NULL DEFAULT NULL COMMENT '税额',
  ...
  `TARGET_REPAIRSHOP` varchar(1024) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '标的车修理厂',
  `THIRD_REPAIRSHOP` varchar(1024) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '三者车修理厂',
  `THIRD_SURVEYOR_CODE` varchar(512) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '三者车查勘员代码',
  `THIRD_SURVEYOR_NAME` varchar(512) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '三者车查勘员名称',
...
) ENGINE = InnoDB AUTO_INCREMENT = 15189 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '已抵清单受托 ' ROW_FORMAT = Dynamic;
