...
-- ----------------------------
-- Table structure for lp_plan_recourse_detail
-- ----------------------------
DROP TABLE IF EXISTS `lp_plan_recourse_detail`;
CREATE TABLE `lp_plan_recourse_detail`  (
  ...
  `PLAN_RECOURSE_MONEY` decimal(32, 8) NULL DEFAULT NULL COMMENT '应追偿金额',
...
) ENGINE = InnoDB AUTO_INCREMENT = 58862 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '应追偿监控清单 41家分公司应追偿明细' ROW_FORMAT = Dynamic;
