...
-- ----------------------------
-- Table structure for lp_recovery_money
-- ----------------------------
DROP TABLE IF EXISTS `lp_recovery_money`;
CREATE TABLE `lp_recovery_money`  (
  ...
  `RECOVERY_MONEY_INVESTIGATION` decimal(32, 8) NULL DEFAULT NULL COMMENT '调查追偿金额',
...
) ENGINE = InnoDB AUTO_INCREMENT = 85 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '追偿金额报表' ROW_FORMAT = Dynamic;
