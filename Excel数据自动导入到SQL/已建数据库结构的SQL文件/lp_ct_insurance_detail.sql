...
-- ----------------------------
-- Table structure for lp_ct_insurance_detail
-- ----------------------------
DROP TABLE IF EXISTS `lp_ct_insurance_detail`;
CREATE TABLE `lp_ct_insurance_detail`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 2380 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '交强险追偿明细报表' ROW_FORMAT = Dynamic;
